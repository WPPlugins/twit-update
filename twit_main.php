...
{
    add_options_page("Twit-update", "Twit-update", 0, 'twit-update/twit_options.php');
}
...
$twit_message=str_replace("[a]",get_userdata($twit_p->post_author)->display_name,$twit_message);
